...
protoc --grpc-swift_opt=Client=false,Server=true --grpc-swift_out=${rootabspath}/Server/Sources/GRPCGenerated --swift_out=${rootabspath}/Server/Sources/GRPCGenerated --proto_path "${rootabspath}"/Protos ${rootabspath}/Protos/*.proto
